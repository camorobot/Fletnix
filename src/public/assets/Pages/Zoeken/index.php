            ...
            <div class="form-wrapper">
                ...
                <div class="form-container">
                    <div class="input-container">
                        <label for="zoek-form-titel">Film Titel</label>
                        <input placeholder="Formula 1" id="zoek-form-titel" name="text-titel" type="text">
                    </div>
                    <div class="input-container">
                        <label for="zoek-form-genre">Genre</label>
                        <input placeholder="Horror" id="zoek-form-genre" name="text-genre" type="text">
                    </div>
